...
public class BHGEOrderEnquiryEmailData {
	...
	public String toString() {
		return "BHGEOrderEnquiryEmailData [userName=" + userName + ", emailIds=" + emailIds + ", businessName="
				+ businessName + ", orderNumber=" + orderNumber + ", poNumber=" + poNumber + ", datePlaced="
				+ datePlaced + ", enquiryType=" + enquiryType + ", inquiryDetails=" + inquiryDetails + ", subject="
