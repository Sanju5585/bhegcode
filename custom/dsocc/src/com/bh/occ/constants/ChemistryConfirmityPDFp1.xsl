		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="my_page">
				...
				<fo:block space-after="2mm" margin-left="1mm" text-align="right">
					<fo:external-graphic  content-height="50%" src="url(https://8oh79k30pcc2zddg9e1ugev.blob.core.windows.net/waygatefilm/LOGO.png)" />
				</fo:block>
				<fo:block> </fo:block>
					...
					<fo:external-graphic  content-height="50%" src="url(https://8oh79k30pcc2zddg9e1ugev.blob.core.windows.net/waygatefilm/Signature.png)" />
					</fo:block>
