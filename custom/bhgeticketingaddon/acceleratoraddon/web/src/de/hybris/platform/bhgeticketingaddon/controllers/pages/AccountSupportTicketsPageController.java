...
public class AccountSupportTicketsPageController extends AbstractSearchPageController
{
	...
	public String addSupportTicket(final Model model) throws CMSItemNotFoundException
	{
		...
		if(customerData != null && customerData.getUid() != null && !StringUtils.equalsIgnoreCase(customerData.getUid(), "anonymous")) {
			GEEdgeCustomerModel customerModel =  userProfileService.findCurrentUserProfile(customerData.getUid());
			String contactName = customerModel != null && customerModel.getShippingContactName() != null ? customerModel.getShippingContactName() : "";
			String contactNumber = customerModel != null && customerModel.getShippingContactNumber() != null ? customerModel.getShippingContactNumber() : "";
			...
			supportTicketForm.setPhoneNo(contactNumber);
