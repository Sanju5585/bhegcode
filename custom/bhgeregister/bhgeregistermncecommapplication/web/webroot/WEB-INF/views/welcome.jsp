...
<html>
<head>
    <title>Welcome to bhgeregistermncecommapplication</title>
    <link rel="stylesheet" href="<c:url value="/static/bhgeregistermncecommapplication-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "bhgeregistermncecommapplication" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/bhgeregistermncecommapplication-items.xml</b> - here you can model your items</li>
            <li><b>resources/bhgeregistermncecommapplication-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/bhgeregistermncecommapplication-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/bhgeregistermncecommapplication-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/bhgeregistermncecommapplication-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
