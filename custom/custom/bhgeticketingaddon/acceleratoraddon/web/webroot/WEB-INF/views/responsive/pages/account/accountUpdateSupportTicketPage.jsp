...
<%@ taglib prefix="cts" tagdir="/WEB-INF/tags/addons/bhgeticketingaddon/cts"%>
                    ...
                    <div style="display:block;" class="cs_file_upload form-group file-upload js-file-upload">
                        ...
                        <span class="file-upload__file-name js-file-upload__file-name">
                         ...
                         <div class="m-t-10 error selectedFile d-none"><spring:theme code="checkout.fileupload.allowedfiles.message" text="Only .pdf,.jpg can be uploaded."/>
                          ...
                          <div class="m-t-10 error selectedFileSize d-none"><spring:theme code="checkout.fileupload.allowedfiles.message.size" text="File size should be less than 10MB."/></div>
                    </div>
