...
//import static org.fest.assertions.assertThat;
...
import com.bhge.register.integration.oidc.service.impl.DefaultBhgeregisteroidcintegrationService;
 ...
 */
@IntegrationTest
public class DefaultBhgeregisteroidcintegrationServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "bhgeregisteroidcintegrationPlatformLogo";

		// when
		final String logoUrl = bhgeregisteroidcintegrationService.getHybrisLogoUrl(logoCode);
