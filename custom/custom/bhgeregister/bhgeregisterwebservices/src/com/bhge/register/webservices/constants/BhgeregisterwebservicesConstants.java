...
/**
 * Global class for all Bhgeregisterwebservices constants. You can add global constants for your extension into this
 * class.
 */
@SuppressWarnings(
{ "deprecation", "squid:CallToDeprecatedMethod" })
public final class BhgeregisterwebservicesConstants extends GeneratedBhgeregisterwebservicesConstants
{
	...
	private BhgeregisterwebservicesConstants()
	{
