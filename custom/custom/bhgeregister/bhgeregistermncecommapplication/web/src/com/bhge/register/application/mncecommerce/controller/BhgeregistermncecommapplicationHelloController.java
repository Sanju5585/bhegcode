 ...
 */
package com.bhge.register.application.mncecommerce.controller;
...
@Controller
public class BhgeregistermncecommapplicationHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", bhgeregistermncecommapplicationService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
