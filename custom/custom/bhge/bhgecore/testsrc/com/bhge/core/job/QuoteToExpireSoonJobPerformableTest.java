 ...
 */
package com.bhge.core.job;

import static com.bhge.core.job.QuoteToExpireSoonJobPerformable.DAYS_TO_EXPIRE;
import static com.bhge.core.job.QuoteToExpireSoonJobPerformable.DEFAULT_DAYS_TO_EXPIRE;
...
public class QuoteToExpireSoonJobPerformableTest
{
	...
	public void testPerform()
	{
        ...
        //TODO UPGRADE 2205: change to the correct matcher
		//searchResult.getResult().stream().forEach(quoteModel -> verify(eventService).publishEvent(argThat(hasProperty("quote", sameInstance(quoteModel)))));
	}
