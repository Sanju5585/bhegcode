...
public class Input
{
	...
	@JsonProperty("Country_ge_og__c")
	private String country;
	private String state;
	private String city;
	private String postalCode;
	@JsonProperty("MCProductApplicationMkto")
	private String areaOfInterest;
	private String mktoPersonNotes;
	@JsonProperty("Opt_In_ge_og__c")
	private boolean optIn;
	private String leadSource;
	@JsonProperty("lead_source_details_ge_og__c")
	private String leadSourceDetails;
	@JsonProperty("inquiry_type_ge_og__c")
	...
	/**
	 * @return the mktoPersonNotes
	 */
	public String getMktoPersonNotes()
	{
		return mktoPersonNotes;
	}

	/**
	 * @param mktoPersonNotes
	 *           the mktoPersonNotes to set
	 */
	public void setMktoPersonNotes(final String mktoPersonNotes)
	{
		this.mktoPersonNotes = mktoPersonNotes;
	}
