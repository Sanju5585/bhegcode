...
@JacksonXmlRootElement( localName = "rfc:Z_SORDER_HISTORY.Response")
@JsonPropertyOrder({"CUST_NO", "MT_SALES_ORDER_DELIVERY", "MT_SALES_ORDER_HEADER", "MT_SALES_ORDER_ITEM", "T_MESSAGETABLE"})
public class ZOrderHistoryResponse {
