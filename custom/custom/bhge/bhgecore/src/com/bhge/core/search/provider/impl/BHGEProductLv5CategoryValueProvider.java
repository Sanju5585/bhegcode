...
public class BHGEProductLv5CategoryValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{

    private static final Logger LOG = Logger.getLogger(BHGEProductLv5CategoryValueProvider.class);
    ...
    private final static String LVL = "LVL5";
    ...
    public Collection<FieldValue> getFieldValues(IndexConfig indexConfig, IndexedProperty indexedProperty, Object product) throws FieldValueProviderException {
        LOG.info("TA942585: Inside LVL5 Value Provider");
