...
public class BHGEGlobalCatalogProductLineMappingCronJob extends AbstractJobPerformable<CronJobModel>
{
	...
	public PerformResult perform(CronJobModel cronJob)
	{
		try {
   		...
   		List<GEEdgeProductModel> products = new ArrayList<GEEdgeProductModel>();
			/*
			 * if(null == lastRunTime) { lastRunTime = new Date(); }
			 */
   		LOG.info("BHGEGlobalCatalogProductlinemapping job started");
   		//LOG.debug("Last Runtime: " + lastRunTime.toString());
   		if(null!= lastRunTime) {
      		formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
      		products = productService.getNewAndUpdatedProductsforGlobalCatalog(formatter.format(lastRunTime));
   		}
   		else {
      		products = productService.getNewAndUpdatedProductsforGlobalCatalog(null);
   		}
   		...
   		LOG.info("BHGEGlobalCatalogProductlinemapping job is finished");
