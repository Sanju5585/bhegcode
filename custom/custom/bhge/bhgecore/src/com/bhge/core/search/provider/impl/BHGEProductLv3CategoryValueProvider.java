...
public class BHGEProductLv3CategoryValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{

    private static final Logger LOG = Logger.getLogger(BHGEProductLv3CategoryValueProvider.class);
    ...
    private final static String LVL = "LVL3";
    ...
    public Collection<FieldValue> getFieldValues(IndexConfig indexConfig, IndexedProperty indexedProperty, Object product) throws FieldValueProviderException {
        LOG.info("TA942585: Inside LVL3 Value Provider");
