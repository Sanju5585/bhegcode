...
public class BHGEHybrisStatusValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider

{

	private final static Logger LOG = Logger.getLogger(BHGEHybrisStatusValueProvider.class);
			...
			final Object model) throws FieldValueProviderException
	{
		...
		if (model instanceof GEEdgeProductModel)
		{
			...
			final HybrisStatus hybrisStatus = geEdgeProductModel.getHybrisStatus();

			if (null != hybrisStatus)
			{
				fieldValues.add(new FieldValue(indexedProperty.getExportId() + "_string", hybrisStatus.getCode()));
			}
		}
		return fieldValues;
	}
