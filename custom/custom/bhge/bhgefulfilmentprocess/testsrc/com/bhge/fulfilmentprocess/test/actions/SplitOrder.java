 ...
 */
package com.bhge.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(BhgeFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BhgeFulfilmentProcessConstants.PARENT_PROCESS);
