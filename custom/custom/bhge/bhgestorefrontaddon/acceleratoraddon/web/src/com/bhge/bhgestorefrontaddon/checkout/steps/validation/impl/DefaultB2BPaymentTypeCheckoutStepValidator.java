 ...
 */
package com.bhge.bhgestorefrontaddon.checkout.steps.validation.impl;

import de.hybris.platform.acceleratorstorefrontcommons.checkout.steps.validation.ValidationResults;
import com.bhge.bhgestorefrontaddon.checkout.steps.validation.AbstractB2BCheckoutStepValidator;
...
public class DefaultB2BPaymentTypeCheckoutStepValidator extends AbstractB2BCheckoutStepValidator
{
	...
	public ValidationResults validateOnExit()
	{
		...
		//Commented as new condition need to be checked for skipping Shipping Address Details
