...
public class BHGEProductLv4CategoryValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{

    private static final Logger LOG = Logger.getLogger(BHGEProductLv4CategoryValueProvider.class);
    ...
    private final static String LVL = "LVL4";
    ...
    public Collection<FieldValue> getFieldValues(IndexConfig indexConfig, IndexedProperty indexedProperty, Object product) throws FieldValueProviderException {
        LOG.info("TA942585: Inside LVL4 Value Provider");
