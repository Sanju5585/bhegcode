...
public class BHGEProductLv2CategoryValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{

    private static final Logger LOG = Logger.getLogger(BHGEProductLv2CategoryValueProvider.class);
    ...
    private final static String LVL = "LVL2";
    ...
    public Collection<FieldValue> getFieldValues(IndexConfig indexConfig, IndexedProperty indexedProperty, Object product) throws FieldValueProviderException {
        LOG.info("TA942585: Inside LVL2 Value Provider");
