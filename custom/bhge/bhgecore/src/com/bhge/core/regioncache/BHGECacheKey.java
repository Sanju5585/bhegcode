...
public class BHGECacheKey implements CacheKey
{

	private static final String BHGE_CACHE_CODE = "_ORDER_HISTORY_CACHE_";
	private String key = null;
	private String tenantId = null;

	public BHGECacheKey(final String key, final String tenantId)
	{
		this.key = key;
	...
	public boolean equals(final Object obj)
	{
		...
		final BHGECacheKey other = (BHGECacheKey) obj;
		if (tenantId == null)
		{
