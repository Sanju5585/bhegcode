 ...
 */
public class GEEdgeCacheCleanerJob extends AbstractJobPerformable<GEEdgeCacheCleanerJobModel>
{

	private static final Logger LOG = Logger.getLogger(GEEdgeCacheCleanerJob.class);
