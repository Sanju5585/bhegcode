...
@JacksonXmlRootElement(localName ="item")public class ZHYBRmaNotifDocAttcRequest$Item {


    private List<ZHYBRmaNotifDocAttcRequest$Item> items;

    public ZHYBRmaNotifDocAttcRequest$Item() {
        this.items = new LinkedList<>();
    }

    @JacksonXmlProperty(localName = "item")
    @JacksonXmlElementWrapper(useWrapping = false)
    public List<ZHYBRmaNotifDocAttcRequest$Item> getItems() {

        return this.items;
    }
    public void setItems(List<ZHYBRmaNotifDocAttcRequest$Item> items) {
        this.items = items;
    }
