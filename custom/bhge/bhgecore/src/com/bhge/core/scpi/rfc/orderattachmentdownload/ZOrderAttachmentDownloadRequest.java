...
@JacksonXmlRootElement(localName ="Z_S_ORDER_PDF")
@JsonPropertyOrder({"CUSTOMER", "IM_DELIVERY_NUMBER", "IM_IDENTIFIER", "IM_INVOICE_NUMBER", "IM_SALES_ORDER", "T_CUSTOM_INVOICE", "T_DELIVERY", "T_INVOICELIST", "T_MESSAGETABLE", "T_ORDER" , "T_PO"})
public class ZOrderAttachmentDownloadRequest {
    ...
    private ZOrderAttachmentDownloadRequest$Item t_custinvoice;
	...
	/**
	 * @return the t_custinvoice
	 */
	public ZOrderAttachmentDownloadRequest$Item getT_custinvoice()
	{
		return t_custinvoice;
	}

	/**
	 * @param t_custinvoice the t_custinvoice to set
	 */
	public void setT_custinvoice(ZOrderAttachmentDownloadRequest$Item t_custinvoice)
	{
		this.t_custinvoice = t_custinvoice;
	}
