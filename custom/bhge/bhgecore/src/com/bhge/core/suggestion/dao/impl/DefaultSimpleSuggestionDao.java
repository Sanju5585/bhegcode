 ...
 */
package com.bhge.core.suggestion.dao.impl;
...
import com.bhge.core.suggestion.dao.SimpleSuggestionDao;
...
public class DefaultSimpleSuggestionDao extends AbstractItemDao implements SimpleSuggestionDao
{
	...
	public List<ProductModel> findProductsRelatedToPurchasedProductsByCategory(final CategoryModel category,
			...
			final Integer limit)
	{
		Assert.notNull(category, "Parameter category must not be null");
	...
	public List<ProductModel> findProductsRelatedToProducts(final List<ProductModel> products,
			...
			final Integer limit)
	{
		Assert.notNull(products, "Parameter products must not be null");
		Assert.notNull(user, "Parameter user must not be null");
