 ...
 */
package com.bhge.fulfilmentprocess.strategy.impl;
...
public class SplitByWarehouse implements SplittingStrategy
{
	...
	protected List<WarehouseModel> getPossibleWarehouses(final AbstractOrderEntryModel orderEntry)
	{
		...
		if (orderEntry.getOrder().getStore() != null)
		{
			...
			candidateWarehouses.addAll(orderEntry.getDeliveryPointOfService() == null ? orderEntry.getOrder().getStore()
			...
			{
				final Long availableCount = commerceAvailabilityCalculationStrategy.calculateAvailability(getStockService()
						.getStockLevels(orderEntry.getProduct(), Collections.singletonList(candidateWarehouseModel)));
