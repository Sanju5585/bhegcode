...
/**
 * CheckoutFlowFacade interface extends the {@link CheckoutFacade}. The
 * CheckoutFlowFacade supports resolving the {@link B2BCheckoutFlowEnum} for the
 * current request.
 * 
 * @since 4.6
