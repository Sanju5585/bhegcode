...
public class OrderCancelRepairJob extends AbstractJobPerformable<CronJobModel>
{
	...
	private static final String YSAPORDERFULFILLMENT_REPAIR_JOB_CANCEL_MINUTES = "bhgesaporderfulfillment.repair.job.cancel.minutes";
	...
	public PerformResult perform(final CronJobModel arg0)
	{
		...
		waitProcesses = orderExchangeRepair.findProcessesByActionIds(BhgesaporderfulfillmentConstants.ORDER_PROCESS_NAME, new String[]
