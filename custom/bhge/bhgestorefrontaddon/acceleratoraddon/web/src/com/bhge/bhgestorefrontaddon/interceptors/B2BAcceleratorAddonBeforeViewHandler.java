 ...
 */
package com.bhge.bhgestorefrontaddon.interceptors;
...
public class B2BAcceleratorAddonBeforeViewHandler implements BeforeViewHandler
{
			...
			throws Exception
	{
		...
		{
			modelAndView.setViewName(BhgestorefrontaddonConstants.ADDON_PREFIX + viewMap.get(viewName).get(VIEW_NAME_MAP_KEY));
		}
	}
