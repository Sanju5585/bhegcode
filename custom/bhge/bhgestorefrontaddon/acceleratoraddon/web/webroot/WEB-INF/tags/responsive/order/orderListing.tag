            ...
            <div class="responsive-table">
                <table class="responsive-table">
                    ...
                    <tr class="responsive-table-head hidden-xs">
                        ...
                        <th id="header3"><spring:theme code="text.account.orderHistory.orderType"/></th>
                    ...
                    <c:forEach items="${searchPageData.results}" var="order">
                        <tr class="responsive-table-item">
                            ...
                            <td headers="header3" class="responsive-table-cell">
                               	 <spring:theme code="order.type.${fn:escapeXml(order.orderType)}" />
                            </td>
                            ...
                            <td headers="header5" class="responsive-table-cell responsive-table-cell-bold">
                                ...
                                <div>${fn:escapeXml(order.totalNetPrice)}</div>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
