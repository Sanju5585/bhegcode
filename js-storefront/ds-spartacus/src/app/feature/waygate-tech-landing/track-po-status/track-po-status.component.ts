...
@Component({
  standalone: false,
  selector: 'app-track-po-status',
  templateUrl: './track-po-status.component.html',
  styleUrls: ['./track-po-status.component.scss'],
})
export class TrackPoStatusComponent implements OnInit {
  orderNumber = '';
  purchaseNumber = '';
  customerNumber = '';
