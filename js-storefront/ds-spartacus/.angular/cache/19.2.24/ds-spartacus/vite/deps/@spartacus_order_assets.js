...
var orderTranslationChunksConfig = {
  ...
  order: ["orderDetails", "orderHistory", "AccountOrderHistoryTabContainer", "returnRequestList", "returnRequest", "reorder", "attachments"]
};
...
export {
  ...
  orderTranslations,
  cs as orderTranslationsCs,
  de as orderTranslationsDe,
  en as orderTranslationsEn,
  es as orderTranslationsEs,
  es_CO as orderTranslationsEs_CO,
  fr as orderTranslationsFr,
  hi as orderTranslationsHi,
  hu as orderTranslationsHu,
  id as orderTranslationsId,
  it as orderTranslationsIt,
  ja as orderTranslationsJa,
  ko as orderTranslationsKo,
  pl as orderTranslationsPl,
  pt as orderTranslationsPt,
  ru as orderTranslationsRu,
  zh as orderTranslationsZh,
  zh_TW as orderTranslationsZh_TW
};
//# sourceMappingURL=@spartacus_order_assets.js.map
