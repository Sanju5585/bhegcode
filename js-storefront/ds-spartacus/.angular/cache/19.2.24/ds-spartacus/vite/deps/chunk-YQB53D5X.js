...
// node_modules/@bh-digital-solutions/ui-toolkit/dist/esm/virtualizer-28a7e8dd.js
...
var IronListAdapter = class {
  constructor({
    ...
    this.elementsContainer.addEventListener("focusin", () => {
      this.scrollTarget.dispatchEvent(new CustomEvent("virtualizer-element-focused", {
        detail: {
          element: this.__getFocusedElement()
        }
      }));
    });
...
@bh-digital-solutions/ui-toolkit/dist/esm/virtualizer-28a7e8dd.js:
  (**
   * @license
   ...
   *)
*/
//# sourceMappingURL=chunk-YQB53D5X.js.map
