...
// node_modules/@spartacus/organization/fesm2022/spartacus-organization-order-approval-assets.mjs
...
var orderApprovalTranslationChunksConfig = {
  orderApproval: ["orderApprovalDetails", "orderApprovalList", "orderApprovalGlobal"]
};
var orderApprovalTranslations = {
  en
};
export {
  orderApprovalTranslationChunksConfig,
  orderApprovalTranslations,
  cs as orderApprovalTranslationsCs,
  de as orderApprovalTranslationsDe,
  en as orderApprovalTranslationsEn,
  es as orderApprovalTranslationsEs,
  es_CO as orderApprovalTranslationsEs_CO,
  fr as orderApprovalTranslationsFr,
  hi as orderApprovalTranslationsHi,
  hu as orderApprovalTranslationsHu,
  id as orderApprovalTranslationsId,
  it as orderApprovalTranslationsIt,
  ja as orderApprovalTranslationsJa,
  ko as orderApprovalTranslationsKo,
  pl as orderApprovalTranslationsPl,
  pt as orderApprovalTranslationsPt,
  ru as orderApprovalTranslationsRu,
  zh as orderApprovalTranslationsZh,
  zh_TW as orderApprovalTranslationsZh_TW
};
//# sourceMappingURL=@spartacus_organization_order-approval_assets.js.map
