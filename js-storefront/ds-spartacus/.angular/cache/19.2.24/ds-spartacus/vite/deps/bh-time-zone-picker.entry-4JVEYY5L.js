...
// node_modules/@bh-digital-solutions/ui-toolkit/dist/esm/bh-time-zone-picker.entry.js
var timezones = [{
...
var bhTimeZonePickerCss = ":host{display:block}";
var BhTimeZonePickerStyle0 = bhTimeZonePickerCss;
var BhTimeZonePicker = class {
  constructor(hostRef) {
    ...
    this.placeholder = "Choose time zone";
    this.message = void 0;
    this.isSmall = false;
    this.isFluid = false;
    this.isError = false;
  ...
  handleValue() {
    var _a;
    this.selectedText = (_a = timezones.find((item) => item.text === this.value)) === null || _a === void 0 ? void 0 : _a.value;
  }
  componentWillLoad() {
    const timezoneItems = timezones.map((zone) => {
      return {
        label: `${zone.abbr} - ${zone.text}`,
        value: zone.value
      };
    });
    this.menuItems = {
  ...
  render() {
    const prefix = this.host.tagName.toLowerCase().replace(components.timeZonePicker.tagNameBase, "");
    const Components = generateComponentLiteralWithPrefix(prefix);
    return h(Host, {
      key: "eb9d06a9fe9f1ac64476c37f66968afb5936afc0"
    }, h(Components.dropdown, {
      key: "1fa8452cffe85b6265e29a3fb4f1b18abd9e7e3c",
      onSelected: (event) => {
      ...
      value: this.value,
      selectedValue: this.selectedText,
      label: this.label,
...
BhTimeZonePicker.style = BhTimeZonePickerStyle0;
export {
  BhTimeZonePicker as bh_time_zone_picker
};
//# sourceMappingURL=bh-time-zone-picker.entry-4JVEYY5L.js.map
