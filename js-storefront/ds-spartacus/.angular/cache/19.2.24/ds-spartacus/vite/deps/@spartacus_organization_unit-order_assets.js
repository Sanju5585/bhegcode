...
// node_modules/@spartacus/organization/fesm2022/spartacus-organization-unit-order-assets.mjs
...
var unitOrderTranslationChunksConfig = {
  unitOrder: ["unitLevelOrderHistory", "unitLevelOrderHistorySorting", "unitLevelOrderDetails"]
};
var unitOrderTranslations = {
  en
};
export {
  unitOrderTranslationChunksConfig,
  unitOrderTranslations,
  cs as unitOrderTranslationsCs,
  de as unitOrderTranslationsDe,
  en as unitOrderTranslationsEn,
  es as unitOrderTranslationsEs,
  es_CO as unitOrderTranslationsEs_CO,
  fr as unitOrderTranslationsFr,
  hi as unitOrderTranslationsHi,
  hu as unitOrderTranslationsHu,
  id as unitOrderTranslationsId,
  it as unitOrderTranslationsIt,
  ja as unitOrderTranslationsJa,
  ko as unitOrderTranslationsKo,
  pl as unitOrderTranslationsPl,
  pt as unitOrderTranslationsPt,
  ru as unitOrderTranslationsRu,
  zh as unitOrderTranslationsZh,
  zh_TW as unitOrderTranslationsZh_TW
};
//# sourceMappingURL=@spartacus_organization_unit-order_assets.js.map
